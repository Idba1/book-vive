    ...
    return (
        <div>
            <div className="card card-normal lg:card-side bg-base-100 shadow-xl p-2 lg:p-16 ">
                <figure className="lg:w-1/3 p-10 rounded-xl"><img src="https://daisyui.com/images/stock/photo-1635805737707-575885ab0820.jpg" alt="Movie" className="rounded-xl" /></figure>
